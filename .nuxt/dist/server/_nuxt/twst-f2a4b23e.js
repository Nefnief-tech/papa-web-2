...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  ssrRenderList(_ctx.tableData, (item, index) => {
  ...
  if (_ctx.showToast) {
    _push(`<div class="toast"><div class="alert alert-info"><span>New message arrived.</span></div></div>`);
  } else {
    _push(`<!---->`);
  }
  _push(`<!--]-->`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/twst.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const twst = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);
export {
  twst as default
};
//# sourceMappingURL=twst-f2a4b23e.js.map
