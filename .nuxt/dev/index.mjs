globalThis._importMeta_={url:import.meta.url,env:process.env};import 'file://G:/papa-web/node_modules/node-fetch-native/dist/polyfill.mjs';
import { Server } from 'node:http';
import { tmpdir } from 'node:os';
import { join } from 'node:path';
import { mkdirSync } from 'node:fs';
import { parentPort, threadId } from 'node:worker_threads';
import { defineEventHandler, handleCacheHeaders, createEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, setResponseStatus, getRequestHeader, setResponseHeader, getRequestHeaders, createApp, createRouter as createRouter$1, toNodeListener, fetchWithEvent, lazyEventHandler, getQuery as getQuery$1, createError } from 'file://G:/papa-web/node_modules/h3/dist/index.mjs';
import { createRenderer } from 'file://G:/papa-web/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file://G:/papa-web/node_modules/devalue/index.js';
import { renderToString } from 'file://G:/papa-web/node_modules/vue/server-renderer/index.mjs';
import { createFetch as createFetch$1, Headers } from 'file://G:/papa-web/node_modules/ofetch/dist/node.mjs';
import destr from 'file://G:/papa-web/node_modules/destr/dist/index.mjs';
import { createCall, createFetch } from 'file://G:/papa-web/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file://G:/papa-web/node_modules/hookable/dist/index.mjs';
import { snakeCase } from 'file://G:/papa-web/node_modules/scule/dist/index.mjs';
import { klona } from 'file://G:/papa-web/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file://G:/papa-web/node_modules/defu/dist/defu.mjs';
import { hash } from 'file://G:/papa-web/node_modules/ohash/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery } from 'file://G:/papa-web/node_modules/ufo/dist/index.mjs';
import { createStorage, prefixStorage } from 'file://G:/papa-web/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file://G:/papa-web/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file://G:/papa-web/node_modules/radix3/dist/index.mjs';
...
const serverAssets = [{"baseName":"server","dir":"G:/papa-web/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"G:\\papa-web","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"G:\\papa-web\\server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"G:\\papa-web\\.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"G:\\papa-web\\.nuxt\\cache","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _SyerWR2Zl1 = (function(nitro) {
...
const _rX8ykAQ0zn = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
...
const _lazy_37yKOs = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_37yKOs, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_37yKOs, lazy: true, middleware: false, method: undefined }
];
...
const getClientManifest = () => import('file://G:/papa-web/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getStaticRenderedHead = () => Promise.resolve().then(function () { return _virtual__headStatic$1; }).then((r) => r.default || r);
const getServerEntry = () => import('file://G:/papa-web/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
